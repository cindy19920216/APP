...
export function TechnicalChartMaster() {
  ...
  // 모바일(phone-frame)에서는 부모 .content-area가 overflow:hidden이라
  // .tab-wrap(자체 스크롤 컨테이너)로 감싸야 스크롤이 된다. 데스크톱은 페이지 자체가
  // 스크롤되므로 그대로 둔다.
  return (
    <div className={isDesktop ? undefined : 'tab-wrap'}>
      <Navbar activeTab={activeTab} setActiveTab={setActiveTab} />

      <div style={{ marginTop: isDesktop ? 18 : 0 }}>
        {activeTab === 'theory' && (
